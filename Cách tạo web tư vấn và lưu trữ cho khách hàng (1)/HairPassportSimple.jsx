...
import { Star, User, Calendar, Download } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
          ...
          <div className="flex justify-center items-center gap-4 mt-4">
            <div className="text-center">
              <div className="text-4xl font-bold text-burgundy-600 mb-2">
                {sampleScore.overallScore}/10
              </div>
              <Badge className={sampleScore.healthLevel.color}>
                {sampleScore.healthLevel.level}
              </Badge>
            </div>
            <div className="text-center">
              <div className="text-2xl mb-2">
                {sampleScore.healthLevel.icon}
              </div>
              <p className="text-sm text-gray-600 max-w-xs">
                {sampleScore.healthLevel.description}
              </p>
            </div>
          </div>
        </CardHeader>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {Object.entries(sampleScore.categoryScores).map(([category, score]) => (
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <Button 
          variant="outline"
          onClick={() => alert('Tính năng xuất PDF sẽ được phát triển trong phiên bản tiếp theo')}
